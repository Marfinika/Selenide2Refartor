...
![](https://github.com/Marfinika/aqa-homeworks/blob/master/selenide/pic/loading.png))
...
![](https://raw.githubusercontent.com/Marfinika/aqa-homeworks/master/selenide/pic/popup.png))

2. Выбор даты на неделю вперёд, начиная от текущей даты, через инструмент календаря:

![](https://raw.githubusercontent.com/Marfinika/aqa-homeworks/master/selenide/pic/dropdown.png))
